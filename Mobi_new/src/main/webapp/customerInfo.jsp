...
<body>
    ...
    <div class="user-update-content">
        ...
        <c:forEach items="${inforUser}" var="o">
	        <label for="username">Tên đăng nhập: </label>
	        <p name="username" class=" infor"><b>${o.username}</b></p><br><br>
		</c:forEach>
    ...
    <script>
        ...
        $(document).ready(function() {
            // Mặc định chọn nút "Hoạt động"
            $('input[value="Hoạt động"]').prop('checked', true);

            // Ẩn mờ nút khác
            $('input[name="radio-tt"]').not(':checked').parent().addClass('disabled');
        });
    </script>
</body>
</html>